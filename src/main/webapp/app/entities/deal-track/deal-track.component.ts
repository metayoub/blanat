...
@Component({
  selector: 'jhi-deal-track',
  templateUrl: './deal-track.component.html',
})
export class DealTrackComponent implements OnInit, OnDestroy {
  ...
  trackId(index: number, item: IDealTrack): number {
    // eslint-disable-next-line @typescript-eslint/no-unnecessary-type-assertion
    return item.id!;
  }

  registerChangeInDealTracks(): void {
    this.eventSubscriber = this.eventManager.subscribe('dealTrackListModification', () => this.loadPage());
  }

  delete(dealTrack: IDealTrack): void {
    const modalRef = this.modalService.open(DealTrackDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.dealTrack = dealTrack;
  }
