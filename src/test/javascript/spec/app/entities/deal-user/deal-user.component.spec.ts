...
import { DealUserComponent } from 'app/entities/deal-user/deal-user.component';
...
describe('Component Tests', () => {
  describe('DealUser Management Component', () => {
    let comp: DealUserComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DealUserComponent, '')
        .compileComponents();
