...
import { DealCommentComponent } from 'app/entities/deal-comment/deal-comment.component';
...
describe('Component Tests', () => {
  describe('DealComment Management Component', () => {
    let comp: DealCommentComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DealCommentComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.dealComments && comp.dealComments[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
