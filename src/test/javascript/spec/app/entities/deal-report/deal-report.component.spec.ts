...
import { DealReportComponent } from 'app/entities/deal-report/deal-report.component';
...
describe('Component Tests', () => {
  describe('DealReport Management Component', () => {
    let comp: DealReportComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DealReportComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.dealReports && comp.dealReports[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
